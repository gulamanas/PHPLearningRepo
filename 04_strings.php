...
$name = 'Anas';
$string = 'Hello I am ' . $name . '. I am 23';
$string2 = "Hello I am $name. I am 23";
// differnce between using single quotation and double quotation
// you can be able to use variable without including quotation in double quotation
// however in single quotation you have to concatenate variable name
echo $string . '<br>';
echo $string2 . '<br>';
...
$longText = "
Hello, my name is <b>Anas</b>
I am 23,
I love <b>Programming</b>
";
echo "1 - " . $longText . '<br>';
